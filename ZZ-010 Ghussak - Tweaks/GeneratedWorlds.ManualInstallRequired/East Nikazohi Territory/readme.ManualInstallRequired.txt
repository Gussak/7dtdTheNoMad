...
And copy these files (after backuping existing ones):
  prefabs.xml
  spawnpoints.xml (edit to enable the snow biome spawns if you prefer an ultra hard start, better only after you get used to the new gameplay overall difficulty)
